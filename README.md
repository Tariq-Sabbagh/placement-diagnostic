# Placement Diagnostic — Find Your Starting Phase
...
- **[math.md](math.md)** — Math questions

---

## Ground rules

- **Leave blank what you haven't learned.** The questions get harder on purpose and reach into material
  you may never have seen. **Skipping is expected and not penalized** — an honest blank tells us exactly
  where to start you. A guess only places you too high, where you'll struggle.
- **Don't look things up or use AI.** This is graded to *help* you, not to grade you. A borrowed answer
  helps no one.
